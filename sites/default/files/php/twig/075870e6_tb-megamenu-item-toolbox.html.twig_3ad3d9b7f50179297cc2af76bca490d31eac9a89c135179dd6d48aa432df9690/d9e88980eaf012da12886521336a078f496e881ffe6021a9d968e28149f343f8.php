...
class __TwigTemplate_2cfb7e2b9fbc2615f12311224a174ccaa65f11a4bdcd60586c16a2d40be8d47f extends Twig_Template
{
  ...
  <h3>";
        // line 2
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Item Configuration")));
  ...
  <p>";
        // line 3
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("This allows you to configure each link you added in the Drupal core menu. You can: add block, have it styled by adding extra class, set icon (Bootstrap icons) and add description.")));
        echo "</p>
  <ul id=\"toogle-submenu-wrapper\">
    <li>
      <label class=\"hasTip\" title=\"";
        // line 6
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Submenu")));
        echo " - ";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Enable or disable submenu")));
        echo "\">";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Submenu")));
        echo "</label>
      <fieldset class=\"radio btn-group toolitem-sub\">
        ...
        // line 9
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Disable submenu")));
        echo "\">";
        ...
        // line 11
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Enable submenu")));
        echo "\">";
  ...
  <ul id=\"toogle-group-wrapper\">
    <li>
      <label class=\"hasTip\" title=\"";
        // line 17
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Group")));
        echo " - ";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Configure how this item’s submenu display")));
        echo "\">";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Group")));
        echo "</label>
      <fieldset class=\"radio btn-group toolitem-group\">
        ...
        // line 20
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Submenu items show only when hover/click on this tem.")));
        echo "\">";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("No")));
        echo "</label>
        ...
        // line 22
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Submenu items are visible under this item.")));
        echo " \">";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Yes")));
        echo "</label>
      </fieldset>
  ...
  <ul id=\"toogle-break-column-wrapper\">
    <li>
      <label class=\"hasTip\" title=\"";
        // line 28
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Break column")));
        echo " - ";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Move the item to the left/right column, create new column if there’s none on the chosen side.")));
        echo "\">";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Break column")));
        echo "</label>
      <fieldset class=\"btn-group\">
        ...
        // line 30
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Move the items to the left column.")));
        echo "\"><i class=\"icon-arrow-left\"></i></a>
        <a href=\"\" class=\"btn toolitem-moveright toolbox-action\" data-action=\"moveItemsRight\" title=\"";
        // line 31
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Move the items to the right column.")));
  ...
  <ul>
    <li title=\"";
        // line 44
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Icon")));
        echo " - ";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Add Icon for Menu Item. Click Icon label to visit Bootstrap icons page and get Icon Class. E.g.: icon-search")));
        echo "\">
      <label class=\"hasTip\">
  ...
  <ul>
    <li title=\"";
        // line 54
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Item caption")));
        echo " - ";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(t("Add caption to this item")));
        echo "\">
      <label class=\"hasTip\">
        ";
        // line 56
...
";
    ...
    {
        return array (  176 => 56,  169 => 54,  158 => 46,  151 => 44,  141 => 37,  135 => 36,  127 => 31,  123 => 30,  114 => 28,  103 => 22,  96 => 20,  86 => 17,  75 => 11,  68 => 9,  58 => 6,  52 => 3,  46 => 2,  43 => 1,);
    }
}
