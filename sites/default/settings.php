 ...
 * @endcode
 */
$settings['hash_salt'] = '1j21xb4o35tRb3WMKlR1VNFg8Osm7vN2LF1tYploYIxOfxQLUbb1klxrTE3fA6m7Gk0t43Fyvg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_esprod_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_esprod_dd.inc';
}
// </DDSETTINGS>
